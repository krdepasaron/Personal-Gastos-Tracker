...
GO
:setvar DatabaseName "PGTDB"
:setvar DefaultFilePrefix "PGTDB"
...
GO
PRINT N'Creating Table [dbo].[pgtgastos]...';
...
GO
PRINT N'Creating Table [dbo].[pgtuser]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[fk_gastos_user]...';


GO
ALTER TABLE [dbo].[pgtgastos]
    ADD CONSTRAINT [fk_gastos_user] FOREIGN KEY ([userId]) REFERENCES [dbo].[pgtgastos] ([Id]);


GO
PRINT N'Creating Procedure [dbo].[lagay]...';
...
GO
PRINT N'Creating Procedure [dbo].[listgastos]...';
...
GO
PRINT N'Creating Procedure [dbo].[register]...';
...
GO
PRINT N'Creating Procedure [dbo].[showdateofgastos]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '848486fd-b1c3-42ab-998e-da2a7627fb6e')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('848486fd-b1c3-42ab-998e-da2a7627fb6e')
